...
const ERROR_CODES = {
  MISSING_TOKEN: 'err_selene_mod_initialization_failure:detail_missing_token',
  WARNING_FILE_READ: 'err_selene_mod_warning_file_read',
  NO_PERMISSION_KICK: 'err_selene_mod_execution_failure:detail_no_permission_kick',
  NO_PERMISSION_BAN: 'err_selene_mod_execution_failure:detail_no_permission_ban',
  NO_PERMISSION_MUTE: 'err_selene_mod_execution_failure:detail_no_permission_mute',
  NO_PERMISSION_UNMUTE: 'err_selene_mod_execution_failure:detail_no_permission_unmute',
  NO_PERMISSION_PURGE: 'err_selene_mod_execution_failure:detail_no_permission_purge',
  NO_PERMISSION_WARN: 'err_selene_mod_execution_failure:detail_no_permission_warn',
  NO_PERMISSION_LOCKDOWN: 'err_selene_mod_execution_failure:detail_no_permission_lockdown',
  NO_PERMISSION_UNLOCK: 'err_selene_mod_execution_failure:detail_no_permission_unlock',
  NO_PERMISSION_RESTART: 'err_selene_mod_execution_failure:detail_no_permission_restart',
  NO_PERMISSION_HALT: 'err_selene_mod_execution_failure:detail_no_permission_halt',
  NO_PERMISSION_ELEVATE: 'err_selene_mod_execution_failure:detail_no_permission_elevate',
  NO_PERMISSION_DEBASE: 'err_selene_mod_execution_failure:detail_no_permission_debase',
  NO_PERMISSION_PREFIX_HANDLING: 'err_selene_mod_execution_failure:detail_no_permission_prefix_handling',
  NO_PERMISSION_VERBOSE_DIALOGS: 'err_selene_mod_execution_failure:detail_no_permission_verbose_dialogs',
  INTERNAL_ERROR: 'err_selene_mod_execution_failure:detail_internal_error',
  MISSING_TARGET_KICK: 'err_selene_mod_execution_failure:detail_missing_target_kick',
  MISSING_TARGET_BAN: 'err_selene_mod_execution_failure:detail_missing_target_ban',
  MISSING_TARGET_MUTE: 'err_selene_mod_execution_failure:detail_missing_target_mute',
  MISSING_TARGET_UNMUTE: 'err_selene_mod_execution_failure:detail_missing_target_unmute',
  MISSING_TARGET_WARN: 'err_selene_mod_execution_failure:detail_missing_target_warn',
  UNABLE_TO_KICK: 'err_selene_mod_execution_failure:detail_unable_to_kick',
  UNABLE_TO_BAN: 'err_selene_mod_execution_failure:detail_unable_to_ban',
  USER_ALREADY_MUTED: 'err_selene_mod_execution_failure:detail_user_already_muted',
  USER_NOT_MUTED: 'err_selene_mod_execution_failure:detail_user_not_muted',
  INVALID_PURGE_AMOUNT: 'err_selene_mod_execution_failure:detail_invalid_purge_amount',
  WARNING_SAVE_FAILURE: 'err_selene_mod_execution_failure:detail_warning_save_failure',
  UNKNOWN_COMMAND: 'err_selene_mod_execution_failure:detail_unknown_command_action',
  NO_PERMISSION_EXECUTION_REDLINE: 'err_selene_mod_execution_failure:detail_no_permission_execution_redline',
  ROLE_PERMISSION_UPDATE_FAILURE: 'err_selene_mod_execution_failure:detail_role_permission_update_failure',
  COMMANDS_SIMULTANEOUS_EXCEEDED: 'err_selene_mod_execution_failure:detail_commands_simultaneous_execution_redline_exceeded'
};
