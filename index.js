...
const ERROR_CODES = {
  MISSING_TOKEN: 'error_selmf_init_fail:detail_missing_token',
  WARNING_FILE_READ: 'error_selmf_warning_file_read',
  NO_PERMISSION_KICK: 'error_selmf_exec_fail:detail_no_permission_kick',
  NO_PERMISSION_BAN: 'error_selmf_exec_fail:detail_no_permission_ban',
  NO_PERMISSION_MUTE: 'error_selmf_exec_fail:detail_no_permission_mute',
  NO_PERMISSION_UNMUTE: 'error_selmf_exec_fail:detail_no_permission_unmute',
  NO_PERMISSION_PURGE: 'error_selmf_exec_fail:detail_no_permission_purge',
  NO_PERMISSION_WARN: 'error_selmf_exec_fail:detail_no_permission_warn',
  NO_PERMISSION_LOCKDOWN: 'error_selmf_exec_fail:detail_no_permission_lockdown',
  NO_PERMISSION_UNLOCK: 'error_selmf_exec_fail:detail_no_permission_unlock',
  NO_PERMISSION_RESTART: 'error_selmf_exec_fail:detail_no_permission_restart',
  NO_PERMISSION_HALT: 'error_selmf_exec_fail:detail_no_permission_halt',
  ...
  MISSING_TARGET_BAN: 'error_selmf_exec_fail:detail_missing_target_ban',
  MISSING_TARGET_MUTE: 'error_selmf_exec_fail:detail_missing_target_mute',
  MISSING_TARGET_UNMUTE: 'error_selmf_exec_fail:detail_missing_target_unmute',
  MISSING_TARGET_WARN: 'error_selmf_exec_fail:detail_missing_target_warn',
  UNABLE_TO_KICK: 'error_selmf_exec_fail:detail_unable_to_kick',
  UNABLE_TO_BAN: 'error_selmf_exec_fail:detail_unable_to_ban',
  USER_ALREADY_MUTED: 'error_selmf_exec_fail:detail_user_already_muted',
  USER_NOT_MUTED: 'error_selmf_exec_fail:detail_user_not_muted',
  INVALID_PURGE_AMOUNT: 'error_selmf_exec_fail:detail_invalid_purge_amount',
  WARNING_SAVE_FAILURE: 'error_selmf_exec_fail:detail_warning_save_fail',
  UNKNOWN_COMMAND: 'error_selmf_exec_fail:detail_unknown_command_action',
  NO_PERMISSION_EXECUTION_REDLINE: 'error_selmf_exec_fail:detail_no_permission_elevate_execution_redline',
  ROLE_PERMISSION_UPDATE_FAILURE: 'error_selmf_exec_fail:detail_role_permission_update_fail',
  COMMANDS_SIMULTANEOUS_EXCEEDED: 'error_selmf_exec_fail:detail_simultaneous_execution_redline_exceeded'
};
...
const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.INVALID_PURGE_AMOUNT]: {
    ...
    verboseMsg: 'Purge target count must be between 1 and 100 (inclusive). If the purge target count is within that range, please contact the development team as this might be a bug in the code.'
  },
